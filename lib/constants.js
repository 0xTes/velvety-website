...
export const GROWTH_BUTTONS = [
  { emoji: "🔥", label: "OnlyFans Marketing",  href: "/onlyfans-growth" },
  { emoji: "🚀", label: "Fansly Marketing",     href: "/fansly-growth" },
  { emoji: "⭐", label: "Other Platforms",      href: "/other-platforms-growth" },
...
export const TESTIMONIALS = [
  {
    quote: "My email list went from 0 to 1,200 subscribers in 60 days. Velvety handled everything — I just focused on creating.",
    name: "Amara K.",
  ...
  {
    quote: "The resource page they built for me looks so professional. Fans actually comment on it. My conversion rate doubled.",
    name: "Mia L.",
  ...
  {
    quote: "I was sceptical at first but the SEO results speak for themselves. I'm ranking on Google now. Couldn't believe it.",
    name: "Celeste R.",
